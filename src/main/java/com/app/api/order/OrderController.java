...
public class OrderController {
    ...
    public OrderDetailResponse getOrderDetail(@RequestParam(value = "orderid", required = false) Integer orderId) {
        ...
        String sql = " select order_id, product_id, customer_id, order_date, order_status, shipped_date, employee_id, " +
            "payment_type, paid_date, ship_name, ship_address1, ship_address2, ship_city , ship_state, " +
            "ship_postal_code, ship_country, product_code, product_name , category, quantity, unit_price, discount, " +
            "date_allocated, order_item_status, shipping_fee, customer_name, customer_email, customer_company from order_details ";
