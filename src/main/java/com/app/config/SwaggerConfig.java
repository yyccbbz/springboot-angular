...
public class SwaggerConfig {
    ...
    public Docket customImplementation() {
        return new Docket(DocumentationType.SWAGGER_2)
            ...
            // If you want to list all the apis including springboots own
    ...
    private ApiKey apiKey() {
        ...
        // <<< === Create a Heaader (We are createing header named "Authorization" here)
    }
    ...
    SecurityConfiguration security() {
        ...
        return new SecurityConfiguration("emailSecurity_client", "secret", "Spring",
            "emailSecurity", "", ApiKeyVehicle.HEADER, "", ",");
    }
