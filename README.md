...
To modify the database schema or the data you can modify [schema.sql](src/main/resources/sql/schema.sql) and [data.sql](src/main/resources/sql/data.sql) which can be found at `/src/main/resources`
...
userid and password are stored in H2 database. To add/remove users, modify the [data.sql](src/main/resources/sql/data.sql#L3)
